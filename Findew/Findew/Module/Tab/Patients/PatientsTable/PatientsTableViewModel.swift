...
class PatientsTableViewModel {
    ...
    var _patientsData: [PatientDTO] = [
        ...
        .init(id: .init(), name: "김부각", ward: "303", bed: 1, department: .init(id: .init(), name: "아카데미", code: "1"), device: .init(serialNumber: "S-01", batteryLevel: 20, isMalfunctioning: true), currenetLocation: .init(zoneType: nil, zoneName: "화장실", floor: 1, x: 0.2, y: 0.1, lastUpdate: .now), memo: "버거킹 먹을까?", createdAt: "22", updatedAt: "22")
    ]
